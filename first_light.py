...
{map_html}
  ...
  <p class="map-hint">Every square is one function; hover one to see which. The
     figure beside each module name is <strong>never observed of total</strong>.
     The map scrolls, and the report continues below it.</p>
  </div>
</section>
